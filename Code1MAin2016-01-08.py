...
for i in range(len(file_path_list)):
    ...
    for j in range(len(onlyfiles)):
        try:
            ...
            ##
            #"fastprot -I fasta '/home/4/u1we1f44/Documents/appbio15/projekt/data/'+path -O xml | fnj -I xml -O 'newick' -o 'Treeout.txt'"
            ...
            os.system(line)
            #fastprot tempf.name | fnj -O 'newick' -o 'ReducingTreeout.txt' 
	    ...
	    #with tempfile.NamedTemporaryFile() as tempf:
                ...
                #for key in seq_dic:
                    #tempf.write('>'+key+'\n'+seq_dic[key]+'\n')
                #line = 'cat '+tempf.name+' | fastprot -I fasta -O phylip | fnj -I phylip -O "newick" -o "/home/4/u1we1f44/Documents/appbio15/projekt/src/ReducingTreeout.txt"'
                #os.system(line)
                #fastprot tempf.name | fnj -O 'newick' -o 'ReducingTreeout.txt'
                #TreePath=file_path+'/'+RefTree
                #t1=(file=open('/home/4/u1we1f44/Documents/appbio15/projekt/data/'+TreePath,'r'),schema="newick",tree_offset=0)
                #t2=(file=open('/home/4/u1we1f44/Documents/appbio15/projekt/src/ReducingTreeout.txt','r'),schema="newick",tree_offset=0,taxon_namespace=t1.taxon_namespace)
                #t2.encode_bipartitions() 
                #if treecompare.symmetric_difference(t1, t2)==0:
                    #FixedCount += 1
		    #os.remove('/home/4/u1we1f44/Documents/appbio15/projekt/src/ReducingTreeout.txt')	
	...
	#with tempfile.NamedTemporaryFile() as tempf:
            ...
            #for key in seq_dic:
                #tempf.write('>'+key+'\n'+dic[key]+'\n')
            #line = 'cat'+tempf.name+' | fastprot -I fasta -O phylip | fnj -I phylip -O "newick" -o "ReducingTreeout.txt"'
            #os.system(line)
            #fastprot tempf.name | fnj -O 'newick' -o 'ReducingTreeout.txt'
            #TreePath=file_path+'/'+RefTree
            #t1=(file=open('/home/4/u1we1f44/Documents/appbio15/projekt/data/'+TreePath,'r'),schema="newick",tree_offset=0)
            #t2=ts=(file=open('/home/4/u1we1f44/Documents/appbio15/projekt/src/ReducingTreeout.txt','r'),schema="newick",tree_offset=0,taxon_namespace=t1.taxon_namespace)
            #if treecompare.symmetric_difference(t1, t2)==0:
                #FixedCount += 1
		#os.remove('/home/4/u1we1f44/Documents/appbio15/projekt/src/ReducingTreeout.txt')	
	    #else:
